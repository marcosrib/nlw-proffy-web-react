      ...
      <main>
        <form onSubmit={handleCreateClass}>
          ...
          <fieldset>
            ...
            {scheduleItems.map((escheduleItem, index) => {
              return (
                <div key={index.toString()} className="schedule-item">
                  <Select
                    name="week_day"
                    label="Dia da semana"
                    value={escheduleItem.week_day}
